...
sharp <- function(start_date){
  ...
  mod <- function(out, name, suffix){
    ...
    rdd <- rdrobust(y = df$p_outcome, x = df$age_3mos_c, c = 0,
                    p = 1, h= 20, kernel = "uniform", weights = df$n)
    ...
    # Save coefficients
    write.csv(coef, 
              here::here("output", "modelling", paste0("coef_lpm2_",suffix,"_",start_date,".csv")),
              row.names = FALSE)
...
comb <- function(suffix){
  ...
  all_coef <- bind_rows(
                        read_csv(here::here("output", "modelling", paste0("coef_lpm2_",suffix,"_2022-09-03.csv"))),
                        read_csv(here::here("output", "modelling", paste0("coef_lpm2_",suffix,"_2022-10-15.csv"))),
                        read_csv(here::here("output", "modelling", paste0("coef_lpm2_",suffix,"_2022-11-26.csv"))),
                        read_csv(here::here("output", "modelling", paste0("coef_lpm2_",suffix,"_2022-11-27.csv"))),
                        read_csv(here::here("output", "modelling", paste0("coef_lpm2_",suffix,"_2022-11-28.csv"))),
                        read_csv(here::here("output", "modelling", paste0("coef_lpm2_",suffix,"_2022-11-29.csv"))),
                        read_csv(here::here("output", "modelling", paste0("coef_lpm2_",suffix,"_2022-11-30.csv"))),
                        read_csv(here::here("output", "modelling", paste0("coef_lpm2_",suffix,"_2022-12-01.csv"))),
                        read_csv(here::here("output", "modelling", paste0("coef_lpm2_",suffix,"_2022-12-02.csv"))),
                        read_csv(here::here("output", "modelling", paste0("coef_lpm2_",suffix,"_2022-12-03.csv"))),
                        read_csv(here::here("output", "modelling", paste0("coef_lpm2_",suffix,"_2022-12-04.csv"))),
                        read_csv(here::here("output", "modelling", paste0("coef_lpm2_",suffix,"_2022-12-05.csv")))
                        )

  write.csv(all_coef, here::here("output", "modelling", "final", paste0("coef_lpm2_",suffix,"_","all.csv")), 
            row.names = FALSE)
